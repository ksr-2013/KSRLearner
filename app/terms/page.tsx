        ...
        <div className="bg-slate-800 rounded-xl p-8 border border-slate-700 prose prose-invert max-w-none">
          ...
          <div className="text-slate-300 space-y-6">
            <section className="space-y-4">
              ...
              <p>
                This website is operated by KSR Learner. Throughout the site, the terms "we", "us" and "our" refer to KSR Learner. KSR Learner offers this website,
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Section 1 - Online Store Terms</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Section 2 - General Conditions</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Section 3 - Accuracy, Completeness and Timeliness of Information</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Section 4 - Modifications to the Service and Prices</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Section 5 - Products or Services (if applicable)</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Section 6 - Accuracy of Billing and Account Information</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Section 7 - Optional Tools</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Section 8 - Third-Party Links</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Section 9 - User Comments, Feedback and Other Submissions</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Section 10 - Personal Information</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Section 11 - Errors, Inaccuracies and Omissions</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Section 12 - Prohibited Uses</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Section 13 - Disclaimer of Warranties; Limitation of Liability</h2>
              <p>
              ...
              <p>
                In no case shall KSR Learner, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable
                ...
                your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred
                as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their
                possibility.
              </p>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Section 14 - Indemnification</h2>
              <p>
                You agree to indemnify, defend and hold harmless KSR Learner and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors,
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Section 15 - Severability</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Section 16 - Termination</h2>
              <p>
                The obligations and liabilities of the parties incurred prior to the termination date shall survive the website.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="mt-6">
                <strong className="text-white">Publisher:</strong> KSR Learner (Penumantra, India)
              </p>
              <p>
