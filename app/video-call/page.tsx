        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-slate-800 rounded-xl p-6 border border-slate-700 text-center">
              ...
              <p className="text-slate-300 text-sm">Crystal clear video and audio powered by Jitsi Meet</p>
            </div>
          ...
          <div className="mt-8 bg-gradient-to-r from-green-900 to-green-800 rounded-xl p-8 border border-green-700">
            <div className="text-center">
              ...
              <p className="text-green-200 mb-6">
                Use our test page to verify that Jitsi Meet is working correctly before hosting real sessions
              </p>
              <Link 
