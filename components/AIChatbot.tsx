          ...
          <>
            ...
            {mode === 'voice' ? (
              ...
              >
                ...
                >
                  {/* Close button - EXACTLY in top right corner, small white X */}
                  <button
                    onClick={handleClose}
                    className="absolute top-0 right-0 z-[2147483647] text-white hover:opacity-80 transition-opacity p-2"
