            ...
            <>
              ...
              <div className="fixed left-0 top-0 h-screen w-72 max-w-[85vw] bg-slate-800 border-r border-slate-700 shadow-2xl p-3 z-[60] overflow-y-auto">
                ...
                <div className="space-y-1 pb-24">
                  ...
                  <Link href="/flashcards" className="block px-3 py-2 text-slate-300 hover:text-blue-400 hover:bg-slate-700 rounded-lg font-medium transition-colors" onClick={() => setIsMenuOpen(false)}>Flashcards</Link>
                  <Link href="/tech-news" className="block px-3 py-2 text-slate-300 hover:text-blue-400 hover:bg-slate-700 rounded-lg font-medium transition-colors" onClick={() => setIsMenuOpen(false)}>Tech News</Link>
                  <Link href="/os-practice" className="block px-3 py-2 text-slate-300 hover:text-blue-400 hover:bg-slate-700 rounded-lg font-medium transition-colors" onClick={() => setIsMenuOpen(false)}>Retro OS</Link>
